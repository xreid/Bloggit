...
var content = "In order to create this website I used Node.js, Express, Bulma, \
and AWS just to name a few. First I created an Amazon EC2 instance where I  \
could host my app. Because Node projects run on port 3000, I allowed all inbound \
traffic on port 3000. I also had to make a rule in order to connect to the \
instance remotely. I used git and published the project on github so I could \
easily track my progress and work on my local machine before eventually pulling \
the project down to the AWS instance. I used Express and Passport.js to handle \
authentication and session management. In order to prevent csrf attacks I used \
CSURF which generates a token that you embed in the webpage and is cross \
checked when requests are made I also used  Once I had all of the basic \
functionality and security features finished, I figured the website should look \
better than the raw html interface I had. I used the CSS framework Bulma in \
order to make the site look nicer."
 ...
 identification long before the digitial age and they continue to see use as we\
 ...
 is wrongly rejected by the security system it is refered to as insult, \
 and when a person is wrongly accepted, it is called fraud. The ideal biometrics \
 system has a 1:1 fraud/insult rate. Because biometrics can be hard to balance \
 ...
 to be used for communiction by the system's designers. Covert channels are \
 dngerous because they provide a path for sensitive information to be secretly \
 leaked. Example: Alice has top secret clearance while Bob only has confidential \
 ...
 required to compete a simple math equation given in the form of a picture. \
 That is an example of a CAPTCHA The \
 purpose of this is to prevent automated bots from logging in/registering and \
